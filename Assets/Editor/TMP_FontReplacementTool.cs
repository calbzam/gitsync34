// https://discussions.unity.com/t/is-there-any-way-to-replace-font-a-for-font-b-in-textmesh-pro-without-going-thru-all-of-the-texts/764393/7

/*
 * Not sure if anyone still needs this, but I made something quick
 * by duplicating and modifying the code in the TMP_PackageUtilities.cs that @Stephan_B mentioned.
 * 
 * It won¡¯t handle material presets, it just looks for the guid of the font asset
 * and replaces it with which ever one you select.
 * 
 * Put this script in an editor folder
 * and it should show up in the Window ¡æ TextMeshPro ¡æ Project Font Replacement Tool.
 * 
 */
