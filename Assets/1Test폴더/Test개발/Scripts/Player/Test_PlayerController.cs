...
namespace TarodevController
{
    ...
    public class Test_PlayerController : MonoBehaviour, Test_IPlayerController
    {
        ...
        [SerializeField] private Test_ScriptableStats _stats;
        private Rigidbody2D _rb;
        private CapsuleCollider2D _col;
        private Test_FrameInput _frameInput;
        ...
        private void GatherInput()
        {
            ...
            _frameInput = new Test_FrameInput
            {
    ...
    public interface Test_IPlayerController
    {
        ...
        public event Action Jumped;
        public Vector2 Test_FrameInput { get; }
    }
}
